...
class ZonesConfig(AppConfig):
    ...
    def ready(self):
        # try:
            ...
            t20 = Area.objects.get_or_create(id=20)
            t1 = Area.objects.get_or_create(id=1)
            t2 = Area.objects.get_or_create(id=2)
            t3 = Area.objects.get_or_create(id=3)
            t4 = Area.objects.get_or_create(id=4)
            t5 = Area.objects.get_or_create(id=5)
            t6 = Area.objects.get_or_create(id=6)
            t7 = Area.objects.get_or_create(id=7)
            t8 = Area.objects.get_or_create(id=8)
            t9 = Area.objects.get_or_create(id=9)
            t10 = Area.objects.get_or_create(id=10)
            t11 = Area.objects.get_or_create(id=11)
            t12 = Area.objects.get_or_create(id=12)
            t13 = Area.objects.get_or_create(id=12)
            t14 = Area.objects.get_or_create(id=14)
            t15 = Area.objects.get_or_create(id=15)
            t16 = Area.objects.get_or_create(id=16)
            t17 = Area.objects.get_or_create(id=17)
            t18 = Area.objects.get_or_create(id=18)
            t19 = Area.objects.get_or_create(id=19)
            
            AreaConnections.objects.get_or_create(area1=t20, area2=t1)
            ...
            l1 = LocationType.objects.get_or_create(id=1, defaults={'name': "Хранилище"})
            l2 = LocationType.objects.get_or_create(id=2, defaults={'name': "Зона выдачи"})
            l3 = LocationType.objects.get_or_create(id=3, defaults={'name': "Зарядка"})
            l4 = LocationType.objects.get_or_create(id=4, defaults={'name': "Сортировочный центр"})
            ...
            for i in a:
                print(i)
                # Category.objects.get_or_create(id=i[0], name=i[1], weight=i[2])
